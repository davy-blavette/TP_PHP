...
$randomArme = rand(1, 5);
$arme1->setImage("./../sources/epee/epee" .$randomArme. ".png");

$randomArme = rand(1, 2);
$arme2->setImage("./../sources/arc/arc" .$randomArme. ".png");

$randomArme = rand(1, 5);
$arme3->setImage("./../sources/hache/hache" .$randomArme. ".png");

$randomArme = rand(1, 5);
$arme4->setImage("./../sources/fleau/fleau" .$randomArme. ".png");
