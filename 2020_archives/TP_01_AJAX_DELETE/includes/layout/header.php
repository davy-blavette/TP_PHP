...
<nav>
    <ul>
        ...
        <li><a href="index.php?page=galerie" class="<?php echo $page == 'galerie' ? 'active' : ''; ?>">Galerie</a></li>
        <li><a href="index.php?page=contact" class="<?php echo $page == 'contact' ? 'active' : ''; ?>">Contact</a></li>
        <li><a href="index.php?page=login" class="<?php echo $page == 'login' ? 'active' : ''; ?>">Connexion</a></li>
    </ul>
</nav>
