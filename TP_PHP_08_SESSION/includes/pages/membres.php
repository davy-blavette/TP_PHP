...
while ($donnees = $reponse->fetch()) {
    ...
    echo '<tr><td>'.$donnees['PRENOM'].'</td><td>'.$donnees['NOM'].'</td><td><a href="?page=membres&action=delete&id='.$donnees['ID_ADHERENT'].'">Supprimer</a></td><td><a href="?page=membres&action=update&id='.$donnees['ID_ADHERENT'].'">Modifier</a></td></tr>';
